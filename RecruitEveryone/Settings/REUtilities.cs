...
{
    internal static class REUtilities
    {
        ...
        private static string ConfigDirectory
        {
            get
            {
                return System.IO.Path.Combine(EngineFilePaths.ConfigsPath.Path, "ModSettings", "RecruitEveryone");
            }
        }
        ...
        private static PlatformFilePath ConfigFullPath
        {
            get
            {
                return new PlatformFilePath(new PlatformDirectoryPath(PlatformFileType.User, ConfigDirectory), "RecruitEveryoneConfig.txt");
            }
        }
        ...
        public static SaveResult SaveConfigFile(string configProperties)
        {
            ...
            {
                Debug.Print("Could not create Recruit Everyone Config file", 0, Debug.DebugColor.White);
